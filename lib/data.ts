...
export const PORTFOLIO: Property[] = [
  ...
  {
    name: "Bekins Luxury Lofts",
    loc: "Sioux City, Iowa",
    units: 72,
    type: "Class A Mid-Rise",
    built: 1906,
    desc: "Bekins Luxury Lofts is located in downtown Sioux City, Iowa. Bekins is a 72-unit mid-rise apartment building originally built as a warehouse in 1906 (with the distinction of being the first fireproof building in Iowa) and then completely rehabbed and converted into apartments in 2018. Retaining its historic flair, Bekins is a premier, Class A apartment community located across the street from the Hard Rock Hotel & Casino, a major employer and entertainment destination, and is near other major employers and shopping and dining options in downtown Sioux City. Residents enjoy the ability to walk and bike to any downtown destination, including major employers like MercyOne Medical Center (0.6 miles away), the Sioux City Convention Center (0.7 miles away), Tyson Events Center (0.5 miles away), and County, City, & Federal administrative offices including City Hall, District Courthouse, and Public Library (0.3 miles away). Additionally, an under-construction $15MM+ riverfront development on the Missouri River will provide extensive walk and bike paths, trails, and spaces for family gatherings, event spaces, basketball courts, and active recreation lawns, and is a quick walk (15 minutes) or bike ride (5 minutes) away.",
    bg: "#1a2535",
    images: [
      "/uploads/bekins/Bekins-Front-From-Street-1024x514.png",
      "/uploads/bekins/Bekins-Aerial-View.png",
      "/uploads/bekins/Bekins-Clubhouse.png",
      "/uploads/bekins/Bekins-Livingroom.png",
      "/uploads/bekins/Bekins-Livingroom-With-Preserved-Brick-Wall.png",
      "/uploads/bekins/Bekins-Dining-Room-Livingroom.png",
      "/uploads/bekins/Bekins-Kitchen.png",
      "/uploads/bekins/Bekins-Kitchen-3.png",
      "/uploads/bekins/Bekins-Back-From-Parking-Lot.png",
    ],
  },
  {
    name: "46West",
